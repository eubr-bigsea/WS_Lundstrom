...
public class Ws extends Utilities {
  ...
  /*
   * LUNDSTROM (normal parameters number)
   */
  @GET
  @Path("/lundstrom/{value1}/{value2}/{value3}/{value4}/{value5}")
  @Produces(MediaType.TEXT_HTML)
  public Response lundstromCall(
   ...
   */
  @GET
  @Path("/lundstromR/{value1}/{value2}/{value3}/{value4}")
  @Produces(MediaType.TEXT_HTML)
  public Response lundstromExtendedCall(
   ...
   */
  @GET
  @Path("/lundstrom/{nNodes}/{nCores}/{ramGB}/{datasetSize}/{appSessId}/{stage}/{currentTimeStamp}")
  @Produces(MediaType.TEXT_PLAIN)
  public Response lundstromCallStages(
    ...
    if (lundstromPath == null)
      return Response.status(500)
        .entity("Fatal error: LUNDSTROM_HOME not defined in wsi_config.xml ")
        .build();
